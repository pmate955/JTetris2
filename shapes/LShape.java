...
public class LShape extends tetrisShape{
    ...
    public LShape(int maxX, int maxY){
        super();
        this.maxX = maxX;
        this.maxY = maxY;
        position=1;
    ...
    public int[][] step(int[][] mapArray){
        ...
        public int[][] rotate(int[][] mapArray){
            if(position==1 && y<maxY-1 && x>0){
                if(mapArray[x][y+1]==0 && mapArray[x+1][y+1]==0 && mapArray[x][y-1]==0){
                    mapArray[x-1][y]=0;
                    mapArray[x+1][y]=0;
                    mapArray[x+1][y-1]=0;
                    mapArray[x][y+1]=5;
                ...
                if(mapArray[x-1][y]==0 && mapArray[x-1][y+1]==0 && mapArray[x+1][y]==0){
                    mapArray[x][y+1]=0;
                    mapArray[x+1][y+1]=0;
                    mapArray[x][y-1]=0;
                    mapArray[x-1][y]=5;
                ...
                if(mapArray[x-1][y-1]==0 && mapArray[x][y-1]==0 && mapArray[x][y+1]==0){
                    mapArray[x-1][y]=0;
                    mapArray[x-1][y+1]=0;
                    mapArray[x+1][y]=0;
                    mapArray[x-1][y-1]=5;
                ...
                if(mapArray[x-1][y]==0 && mapArray[x+1][y]==0 && mapArray[x+1][y-1]==0){
                    mapArray[x-1][y-1]=0;
                    mapArray[x][y-1]=0;
                    mapArray[x][y+1]=0;
                    mapArray[x-1][y]=5;
